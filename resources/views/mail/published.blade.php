...
<table class="content">
	<tbody>	
		<tr>
			...
			<td class="header"><p>Acceso a módulo de verificación de avances.</p></td>
		</tr>
		<br>
		<tr>
			<td class="body">
				<table class="inner-body" width="70%">
					<tbody>
						...
						<p>Hemos activado su acceso al módulo de verificación de avances del mes {{ $datos['wmes'] }}.</p>
						<br>
						...
						<br>
						<p>Por favor verifique la información del avance de la iniciativa: {{ $datos['winiciativa'] }}</p>
						<br>
						<p>Saludos,</p>
